...
public class EditExpense extends javax.swing.JFrame {
    ...
    public EditExpense() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println(rs.getString(EXPENSE_TYPE));
            }
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        try {
            if (amountText.getText().isEmpty() && dateText.getDate() == null) {
            ...
            String sqlStmt = "update expense set name=?, description=?, amount=?, date =? where id='" + expenseIdText.getText() + "';";
            ...
            preparedStatement.setString(2, descriptionText.getText());
            preparedStatement.setString(3, amountText.getText());
            preparedStatement.setDate(4, new java.sql.Date(dateText.getDate().getTime()));
            preparedStatement.executeUpdate();
            int n = JOptionPane.showOptionDialog(this, "Do you like to update the expense id  " + expenseIdText.getText() + " ?", "Remove Confirmation", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options);
            if (n == JOptionPane.YES_OPTION) {

                int affectedRows = preparedStatement.executeUpdate();
                if (affectedRows > 0) {
                    Utility.showSuccess(this, "Updated the Expense!");
                    clearForm();

                } else {
                    Utility.showError(this, "Nothing was Updated. Please check the expense Id.");
                }
            }
