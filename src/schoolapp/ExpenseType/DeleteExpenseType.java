 ...
 * @author prohit
 */
public class DeleteExpenseType extends javax.swing.JFrame {
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        if (expenseTypeCombo.getSelectedIndex() == -1) {
            Utility.showError(this, "Nothing was Deleted. Please check the expense type.");
            return;
        }
        try {
            connect = Utility.getConnection();
            // Statements allow to issue SQL queries to the database
            String sqlStmt = "DELETE FROM expense_type WHERE expense_category='" + expenseTypeCombo.getSelectedItem().toString() + "';";
            // PreparedStatements can use variables and are more efficient
            preparedStatement = connect.prepareStatement(sqlStmt);
            // "myuser, webpage, datum, summery, COMMENTS from feedback.comments");
            // Parameters start with 1
            Object[] options = {"Yes", "No"};
            int n = JOptionPane.showOptionDialog(this, "Do you like to delete the expense category  " + expenseTypeCombo.getSelectedItem().toString() + " ?", "Remove Confirmation", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options);
            if (n == JOptionPane.YES_OPTION) {
                
                int affectedRows = preparedStatement.executeUpdate();
                if (affectedRows > 0) {
                    Utility.showSuccess(this, "Deleted the Expense type!");
                    clearForm();
                    expenseTypeCombo.removeItem(expenseTypeCombo.getSelectedItem());
                } else {
                    Utility.showError(this, "Nothing was Deleted. Please check the expense type.");
                }
            }
