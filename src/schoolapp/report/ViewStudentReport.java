...
public class ViewStudentReport extends javax.swing.JFrame {
    ...
    private HashMap<String,Integer> batchHash;
    private int FIRST_NAME=1;
    private int LAST_NAME=3;
    private int MIDDLE_NAME=2;
    private Connection connection;
    private Statement stmt;
    private ResultSet searchResult;
    private ResultSet rs;
    private int ID=4;
    private HashMap<String,Integer> studentHash;
...
//        idText.setDocument(new JTextFieldLimit(8));
        ...
        batchNameCombo.addItemListener(new ItemListener() {
    ...
    private void initComponents() {
        ...
        studentNameCombo = new javax.swing.JComboBox();
        ...
        studentNameText.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N

        studentNameCombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                studentNameComboActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(courseNameCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(92, 92, 92)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(feeCategoryCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(batchNameCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(97, 97, 97))))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(studentNameCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(loadBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(23, 23, 23)
                                        .addComponent(studentNameText, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(89, 89, 89)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel7)
                        .addComponent(studentNameCombo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(studentNameText, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void viewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtnActionPerformed
        if(studentNameCombo.getSelectedIndex()==-1){
            Utility.showError(this, "No Student records found which meets the search criteria!");
            return;
        }
        Integer studentId=studentHash.get(studentNameCombo.getSelectedItem().toString());
        ...
        String searchSql = "SELECT F.id  AS FEE_COLLECTION_ID,P.name AS FEE_CATEGORY,P.description AS DESCRIPTION , SUM( fees_paid ) AS Total " +
                    ...
                    "WHERE F.fee_collection_id = C.id AND C.fee_category_id = P.id AND P.batch_id="+batchHash.get(batchNameCombo.getSelectedItem().toString())+
                    " AND P.name ='" +feeCategoryCombo.getSelectedItem().toString()+"'"+
    ...
    private void studentNameComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_studentNameComboActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_studentNameComboActionPerformed
    ...
    private javax.swing.JComboBox studentNameCombo;
    ...
    private void loadBatches() {
        ...
        Integer courseId=courseHash.get(courseName);
        Vector<Object> data = new Vector<Object>();
        //  Connect to an MySQL Database, run query, get result set
        ...
        try {
         ...
         rs = stmt.executeQuery(sql);
            ...
            while (rs.next()) {
                ...
                batchHash.put(batchName, batchId);
    ...
    void loadStudentNames(){
        String batchName=batchNameCombo.getSelectedItem().toString();
        Integer batchId=batchHash.get(batchName);
        Vector<Object> data = new Vector<Object>();
        //  Connect to an MySQL Database, run query, get result set

        String sql = "SELECT S.first_name,S.middle_name,S.last_name, S.id " +
                    "FROM students as S " +
        ...
        try {
         ...
         rs = stmt.executeQuery(sql);
            ...
            while (rs.next()) {
                ...
                String middleName=rs.getString(MIDDLE_NAME).toUpperCase();
                String lastName=rs.getString(LAST_NAME).toUpperCase();
                String fullName=firstName+" "+middleName+" "+lastName;
                comboItems.add(fullName);
                studentHash.put(fullName, studentId);
        ...
        Utility.closeConnections(this, connection, stmt, rs);
        DefaultComboBoxModel model = new DefaultComboBoxModel(comboItems);
        studentNameCombo.setModel(model);
    }
}
